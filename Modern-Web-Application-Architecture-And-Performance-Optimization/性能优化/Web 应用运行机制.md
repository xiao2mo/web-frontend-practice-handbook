[![章节头](https://parg.co/UGp)](https://parg.co/UGZ) 
 - [Rendering](#rendering)
  * [Create/Update DOM](#createupdate-dom)
  * [Request Resources](#request-resources)
  * [Create/Update Render CSSOM(CSS Object Model)](#createupdate-render-cssomcss-object-model)
  * [Create/Update Render Tree](#createupdate-render-tree)
  * [Layout](#layout)
  * [Painting](#painting) 
