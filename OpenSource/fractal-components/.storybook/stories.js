           ...
           aria-label="View source on Github">
            <svg width="80" height="80" viewBox="0 0 250 250"
                ...
                <path
                    ...
                    fill="currentColor" style={{transformOrigin: "130px 106px"}} class="octo-arm"></path>
                <path
        ...
        <h2>
            ...
            <div className="right">
                <div className="source">
                    <a target="__blank"
                       href="https://github.com/wxyyxc1992/Web-Development-And-Engineering-Practices/tree/master/OpenSource/fractal-components/src">点击查看
                        Source</a>
                </div>

                <div className="story-source">
                    点击右上角查看 Story Source
                </div>
            </div>
